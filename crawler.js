...
//  Ethiopian book of enoch from enoksbok.se
const enochsGeez = { chapters: [] };
...
async function fetchSection(chapter) {
  const url = `https://web.archive.org/web/20211115124104if_/http://enoksbok.se/cgi-bin/slaupp.cgi?|1|1||jmfgz`;
  let attempts = 0;
